  ...
  return (
    <div className="h-[680px] relative bg-cover">
      <div className="absolute top-0 right-0 w-[110vw] h-full transition-opacity z-0">
        <img
          alt="hero"
          src="../../Assets/Image/bg-hero1.webp"
          fill
          className={`${
        ...
        <img
          alt="hero"
          src="../../Assets/Image/bg-hero2.webp"
          fill
          className={`${
        ...
        <img
          alt="hero"
          src="../../Assets/Image/bg-hero3.webp"
          fill
          className={`${
        ...
        <img
          alt="hero"
          src="../../Assets/Image/bg-hero4.webp"
          fill
          className={`${
        ...
        <img
          alt="hero"
          src="../../Assets/Image/bg-hero5.webp"
          fill
          className={`${
        ...
        <img
          alt="hero"
          src="../../Assets/Image/bg-hero6.webp"
          fill
          className={`${
